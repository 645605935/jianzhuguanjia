(function(D) {
    ...
    }, browser = {strict: doc.compatMode == "CSS1Compat", webkit: /webkit/i.test(ua), msie: /msie/i.test(ua) && !/opera/i.test(ua), gecko: !/webkit/i.test(ua) && /gecko/i.test(ua), safari: /safari/i.test(ua) && !/maxthon/i.test(ua), cacheswf: /theworld|se\s\d+|greenbrowser/i.test(ua), android: ua.indexOf("android") > -1, iPhone: ua.indexOf("iphone") > -1, winPhone: ua.indexOf("windows phone") > -1, iPad: ua.indexOf("ipad") > -1};
    ...
    var have = doc.compareDocumentPosition ? function(a, b) {
        ...
        var lastOverflow = null, lastScroll = 0;
        return function(on) {
            if (!lastOverflow) {
    ...
    var flier = function(v, g, w, h, pos) {
        extend(this, {obj: v, handle: !g ? null : (typeof g == "string") ? $(g) : g, width: w || v.offsetWidth, height: h || v.offsetHeight, onmousemove: this.drag.doyoodg(this), onmouseup: this.drop.doyoodg(this), pos: pos});
        if (this.handle) {
    ...
    extend(M.prototype, {defUI: function(mark) {
            ...
            var buildOldPage = function(mon, t) {
                ...
                var curF = createEle("iframe", {id: "doyoo_f_frame", src: (t == 1 ? "about:blank" : nurl), frameborder: "0"});
            ...
            var mobileChatHint;
            var onlineHint = {sc: "\u5728\u7EBF\u5BA2\u670D", en: "Online Chat", tc: "\u5728\u7DAB\u5BA2\u670D", ru: "Online Chat"};
            ...
            var createMobileChatHint = function(me) {
                ...
                mobileChatHint = createEle("div", {id: "doyoo_mobile_chat_hint"});
                var mode = D.chat.mobileChatHintMode || 0;
                var size = 30;
                if (mode === 0) {
                    mobileChatHint.style.bottom = (D.chat.mobileChatHintBottom || 130) + "px";
                ...
                var sizePx = size + "px";
                if (mode === 0) {
                    extend(mobileChatHint.style, {width: sizePx, height: sizePx, lineHeight: sizePx, bottom: D.chat.mobileChatHintBottom || 220})
                } else {
                    extend(mobileChatHint.style, {width: "100%", height: sizePx, lineHeight: sizePx, borderRadius: 0, bottom: 0, right: 0})
                }
            ...
            var createChatFrame = function(me) {
                ...
                if ($.mobile) {
                    head = '<div id="doyoo_f_top"></div><div id="doyoo_f_head"></div><div  id="doyoo_f_main"></div>'
                }
                        ...
                        if (msg.type == "msg") {
                            ...
                            if (msg.type == "chatBegin") {
                                ...
                                if (typeof looyuChatBegin == "function") {
                                    looyuChatBegin({userId: msg.data.userId, phone: msg.data.phone})
                                }
                            } else {
                                if (msg.type == "chatEnd") {
                                    me.isChating = false
                                } else {
                                    if (msg.type == "chatFocus" || msg.type == "chatBlur") {
                                    } else {
            ...
            return function(ch, auto, mobileClick, follow) {
                ...
                var fMain = $("doyoo_f_main"), fHead = $("doyoo_f_head");
                this.minimize = $.mobile && !mobileClick;
                var mobileHeight = D.chat.mobileHeight + "%";
                if ($.mobile) {
                    extend(fChat.style, {left: "0px", bottom: "0px", top: "auto", height: "100%", position: "fixed", width: "100%"});
                    fMain.style.height = mobileHeight;
                    fHead.style.top = fMain.style.top = (100 - D.chat.mobileHeight) + "%";
                    extend($("doyoo_f_top").style, {height: "auto", top: 0, bottom: mobileHeight});
                    if (!mobileClick) {
                ...
                if (!$.mobile) {
                    ...
                    if (follow) {
                        var cf = this.chatFollow, mf = +(getCookie("_t99_chat_mini") || 1);
                        if (cf === 2) {
                            this.minForce()
                        } else {
                            if (cf === 1 && mf === 0) {
    ...
    extend(P.prototype, {defUI: function() {
            ...
            var ele = function(et, sn, tar, st, of) {
                var mo = this.mode, sc = ["doyoo_offline", "doyoo_online", "doyoo_offline", "doyoo_offline", "doyoo_offline", "doyoo_other", "doyoo_other", "doyoo_other"], sofft = {sc: ["\u7559\u8a00", "\u81ea\u52a9", "\u7535\u8bdd", "\u7559\u8a00"], en: ["MSG", "AUTO", "CALL", "MSG"], tc: ["\u7559\u8a00", "\u81ea\u52a9", "\u96fb\u8a71", "\u7559\u8a00"], ru: ["MSG", "AUTO", "CALL", "MSG"]}, sont = {sc: ["\u5728\u7ebf", "\u5fd9\u788c", "\u79bb\u5f00"], en: ["CHAT", "BUSY", "AWAY"], tc: ["\u5728\u7dda", "\u5fd9\u788c", "\u96e2\u958b"], ru: ["CHAT", "BUSY", "AWAY"]}, ln = E.lang && (sont[E.lang] && E.lang) || "sc", clk = (et != "gw" && et != "d"), h = '<div class="' + (et == "c" ? "group_content" : "group_title") + '" ';
                h += ">";
                if (clk) {
    ...
    var parseEnv = function(o) {
        ...
        if (E.secure && ev.mon.indexOf("http://") == 0) {
            ev.mon = "https://" + ev.mon.substring(7)
        } else {
            if (!E.secure && ev.mon.indexOf("https://") == 0) {
                ev.mon = "http://" + ev.mon.substring(8)
            }
        }

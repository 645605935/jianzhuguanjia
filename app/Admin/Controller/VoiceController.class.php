...
class VoiceController extends AuthController {
    ...
    public function ajax_add(){
        ...
        if($data){
            ...
            $id = M('Voice')->add($data);
            if($id){
                $row= D('Voice')->relation(true)->find($id);
    ...
    public function ajax_del(){
        ...
        if($id){
            $res=M('Voice')->where(array('id'=>$id))->delete();

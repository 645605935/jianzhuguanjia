...
class FocusController extends AuthController {
    ...
    public function index(){
        ...
        $this->type=M('Type')->where(array('pid'=>1397))->select();
        $this->display();
    }
    ...
    public function ajax_get_row_info(){
        ...
        if($id){
            $row = D('Focus')->relation(true)->find($id);
    ...
    public function ajax_del(){
        ...
        if($id){
            $res=M('Focus')->where(array('id'=>$id))->delete();
